...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    readTime: "6 min read",
    excerpt: "A cheap website can cost far more in lost revenue, security risk, and technical debt.",
    content: [
  ...
  },
  {
    ...
    readTime: "7 min read",
    excerpt: "How a local brand turns social traffic into a system they actually control.",
    content: [
