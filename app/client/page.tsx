  ...
  return (
    <div className="min-h-screen bg-white pb-20 md:pb-0">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 flex items-center justify-around z-40">
        {/* Overview */}
        <a href="/client" className="flex flex-col items-center gap-1 py-4 px-3 text-teal-600 border-b-2 border-teal-600">
        ...
        {/* Projects */}
        <a href="/client/projects" className="flex flex-col items-center gap-1 py-4 px-3 text-slate-500">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Assets */}
        <a href="/client/assets" className="flex flex-col items-center gap-1 py-4 px-3 text-slate-500">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Invoices */}
        <a href="/client/invoices" className="flex flex-col items-center gap-1 py-4 px-3 text-slate-500">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Support */}
        <a href="/client/support" className="flex flex-col items-center gap-1 py-4 px-3 text-slate-500">
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
